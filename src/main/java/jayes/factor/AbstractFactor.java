 ...
 ******************************************************************************/
package jayes.factor;


import jayes.factor.arraywrapper.DoubleArrayWrapper;
import jayes.factor.arraywrapper.IArrayWrapper;
import jayes.factor.opcache.DivisionCache;
import jayes.factor.opcache.IOperationCache;
import jayes.factor.opcache.ModuloCache;
...
public abstract class AbstractFactor implements Cloneable {
     ...
     *
     * @param sumDimensionID -1 for last dimension (default)
     * @return
     */
