 ...
 ******************************************************************************/
package jayes.util.triangulation;
...
public class QuotientGraph {
    ...
    public Set<Integer> getNeighbors(int variable) {
        ...
        for (Graph.Edge e : variablesToElements.getIncidentEdges(variable)) {
    ...
    public void eliminate(int variable) {
        for (int elementNeighbor : getNeighbors(variablesToElements, variable)) { // merge eliminated linkNodeParentChild
            merge(variablesToElements, variable, elementNeighbor);
        }
        for (Graph.Edge e : variables.getIncidentEdges(variable)) { // interconnect neigbors
    ...
    private List<Integer> getNeighbors(Graph graph, int var) {
        ...
        for (Graph.Edge e : graph.getIncidentEdges(var)) {
